interface Decoder {
    ...
    fun ld(register: Int, value: Int) // 6XNN: Store the number NN in register VX
    ...
    fun push(registerX: Int) // FX55: Store the values of registers V0 to VX inclusive in memory starting at address I. I is ld to I+X+1 after the operation
    fun pop(registerX: Int) // FX65: Fill registers V0 to VX inclusive with the values stored in memory starting at address I. I is ld to I + X + 1 after the operation
}